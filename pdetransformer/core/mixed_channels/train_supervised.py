...
class SingleStepSupervised(lightning.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.use_ttt_state_cache_train:
            ...
            model_output = self.model(input, class_labels=labels)
    ...
    def predict_step(self, previous_frame,
        ...
        if return_ttt_state_cache or ttt_state_cache is not None:
            model_output = self.model(
                previous_frame,
            ...
            model_output = self.model(previous_frame, **kwargs)
        pred = model_output.sample
